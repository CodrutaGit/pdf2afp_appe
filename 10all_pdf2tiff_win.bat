...
echo %gs%
set folderIN=e:\OutputTransformPDF2AFP_APPE\win\output\out_PDF\TestFiles\
echo %folderIN%
...
echo Copy.... e:\OutputTransformPDF2AFP_APPE\win\output\out_PDF\TestFiles\PDF\*.tif e:\OutputTransformPDF2AFP_APPE\win\output\out_TIFF\MasterFiles\PDF\
xcopy /y /s /d  e:\OutputTransformPDF2AFP_APPE\win\output\out_PDF\TestFiles\PDF\*.tif e:\OutputTransformPDF2AFP_APPE\win\output\out_TIFF\MasterFiles\PDF\ >> C:\Users\Administrator\Transforms\TestPDF2AFP_APPE\Log\log_win\all_PDF2TIFF_itm-driveraaaa.log 2>&1
