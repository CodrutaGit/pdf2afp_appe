...
mkdir E:\OutputTransformPDF2AFP_APPE\win\output\out_TIFF\MasterFiles
echo mkdir E:\OutputTransformPDF2AFP_APPE\win\output\out_TIFF\MasterFiles
...
c:\Windows\System32\xcopy.exe /T /e e:\TestFiles_folder_structure\TestFiles\* E:\OutputTransformPDF2AFP_APPE\win\output\out_TIFF\MasterFiles\ /s /i
